export const STATION_PRACTICE_DATA = {
  imparfait: {
    id: "imparfait_1_1",
    title: "✏️ Entraînement Immédiat : L'Imparfait",
  ...
  pc_avoir: {
    id: "pc_avoir_1_2",
    title: "✏️ Entraînement Immédiat : Le Passé Composé avec Avoir",
  ...
  pc_etre: {
    id: "pc_etre_1_3",
    title: "✏️ Entraînement Immédiat : Le Passé Composé avec Être",
  ...
  combinaison: {
    id: "imp_vs_pc_1_4",
    title: "✏️ Entraînement Immédiat : Imparfait vs Passé Composé",
    description: "Complétez chaque phrase en choisissant entre l'imparfait et le passé composé selon le contexte.",
    questions: [
  ...
  connecteurs: {
    ...
    title: "✏️ Entraînement Immédiat : Les Connecteurs Logiques",
    description: "Complétez chaque phrase avec le connecteur logique approprié.",
    questions: [
