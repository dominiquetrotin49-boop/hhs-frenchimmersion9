...
const REPRISE_ACTIVITIES = [
  ...
  },
  {
    ...
    description: "Complétez chaque phrase en conjuguant le verbe régulier en -er au présent de l'indicatif. Attention aux particularités de nous avec les verbes en -cer (nous commençons) et en -ger (nous mangeons) !",
    questions: [
      { id: "er_1", textBefore: "En classe de français, nous ", infinitive: "parler", textAfter: " souvent avec nos camarades.", answer: "parlons" },
      { id: "er_2", textBefore: "Est-ce que tu ", infinitive: "habiter", textAfter: " près de l'école ou loin d'ici ?", answer: "habites" },
      { id: "er_3", textBefore: "Le soir, mes amis ", infinitive: "regarder", textAfter: " des vidéos drôles sur leur téléphone.", answer: "regardent" },
      { id: "er_4", textBefore: "Dans l'autobus, j'", infinitive: "écouter", textAfter: " mes chansons préférées avec mes écouteurs.", answer: "écoute" },
      { id: "er_5", textBefore: "Est-ce que vous ", infinitive: "aimer", textAfter: " jouer au soccer après les cours ?", answer: "aimez" },
      { id: "er_6", textBefore: "Dans son casier, elle ", infinitive: "chercher", textAfter: " son cahier et ses crayons.", answer: "cherche" },
      { id: "er_7", textBefore: "Avant le petit quiz, j'", infinitive: "étudier", textAfter: " mes mots de vocabulaire.", answer: "étudie" },
      { id: "er_8", textBefore: "Pendant la pause, les filles ", infinitive: "partager", textAfter: " une bonne collation.", answer: "partagent" },
      { id: "er_9", textBefore: "Pendant les vacances d'été, tu ", infinitive: "voyager", textAfter: " en voiture avec tes parents.", answer: "voyages" },
      { id: "er_10", textBefore: "Quand la cloche sonne, nous ", infinitive: "commencer", textAfter: " tout de suite le travail.", answer: "commençons" },
      { id: "er_11", textBefore: "À midi, nous ", infinitive: "manger", textAfter: " notre dîner à la cafétéria.", answer: "mangeons" },
      { id: "er_12", textBefore: "Pour ce projet d'art, nous ", infinitive: "partager", textAfter: " les crayons et les ciseaux.", answer: "partageons" }
    ]
  },
  {
    id: "reprise_verbes_ir",
    title: "Activité 4 : Verbes en -IR (Texte à trous)",
    description: "Complétez chaque phrase en conjuguant le verbe du 2e groupe (-IR) au présent de l'indicatif. Attention aux terminaisons du pluriel (-issons, -issez, -issent) !",
    questions: [
      { id: "ir_1", textBefore: "Nous ", infinitive: "finir", textAfter: " toujours nos devoirs avant d'aller jouer.", answer: "finissons" },
      { id: "ir_2", textBefore: "Tu ", infinitive: "choisir", textAfter: " une pomme ou une banane pour la collation ?", answer: "choisis" },
      { id: "ir_3", textBefore: "Quand ils étudient bien, les élèves ", infinitive: "réussir", textAfter: " facilement le test.", answer: "réussissent" },
      { id: "ir_4", textBefore: "Avant de répondre à la question, nous ", infinitive: "réfléchir", textAfter: " quelques secondes.", answer: "réfléchissons" },
      { id: "ir_5", textBefore: "Pendant l'adolescence, on ", infinitive: "grandir", textAfter: " très vite de plusieurs centimètres !", answer: "grandit" },
      { id: "ir_6", textBefore: "En classe de sciences, vous ", infinitive: "obéir", textAfter: " aux règles du professeur.", answer: "obéissez" },
      { id: "ir_7", textBefore: "À la fin du concert, les élèves ", infinitive: "applaudir", textAfter: " avec beaucoup d'énergie.", answer: "applaudissent" },
      { id: "ir_8", textBefore: "Le directeur ", infinitive: "punir", textAfter: " les élèves qui arrivent toujours en retard.", answer: "punit" },
      { id: "ir_9", textBefore: "Pour la soirée cinéma, nous ", infinitive: "choisir", textAfter: " un film de comédie très drôle.", answer: "choisissons" },
      { id: "ir_10", textBefore: "Chaque après-midi, je ", infinitive: "finir", textAfter: " mes exercices avant le souper.", answer: "finis" },
      { id: "ir_11", textBefore: "Si vous pratiquez un peu chaque jour, vous ", infinitive: "réussir", textAfter: " sans problème.", answer: "réussissez" },
      { id: "ir_12", textBefore: "À la maison, j'", infinitive: "obéir", textAfter: " toujours à mes parents.", answer: "obéis" }
    ]
  },
  {
    id: "reprise_verbes_re",
    title: "Activité 5 : Verbes en -RE (Texte à trous)",
    description: "Complétez chaque phrase en conjuguant le verbe en -dre au présent de l'indicatif. Attention : à la 3e personne du singulier (il / elle / on), le verbe garde son 'd' et ne prend pas de 't' !",
    questions: [
      { id: "re_1", textBefore: "Le garçon ", infinitive: "attendre", textAfter: " son ami devant la porte de la classe.", answer: "attend" },
      { id: "re_2", textBefore: "Quand le professeur pose une question, elle ", infinitive: "répondre", textAfter: " poliment avec le sourire.", answer: "répond" },
      { id: "re_3", textBefore: "Si on ne range pas bien son sac, on ", infinitive: "perdre", textAfter: " facilement ses crayons.", answer: "perd" },
      { id: "re_4", textBefore: "Dans le couloir, nous ", infinitive: "entendre", textAfter: " la musique du cours de danse.", answer: "entendons" },
      { id: "re_5", textBefore: "Après les cours, vous ", infinitive: "descendre", textAfter: " vite les escaliers pour prendre le bus.", answer: "descendez" },
      { id: "re_6", textBefore: "À la fin de la semaine, les élèves ", infinitive: "rendre", textAfter: " leur devoir au professeur.", answer: "rendent" },
      { id: "re_7", textBefore: "J'", infinitive: "attendre", textAfter: " mon frère près de l'arrêt d'autobus.", answer: "attends" },
      { id: "re_8", textBefore: "Pour ramasser de l'argent pour le club, ils ", infinitive: "vendre", textAfter: " des biscuits à la récréation.", answer: "vendent" },
      { id: "re_9", textBefore: "Mon petit frère ", infinitive: "descendre", textAfter: " de sa chambre pour prendre son petit déjeuner.", answer: "descend" },
      { id: "re_10", textBefore: "Quand nous recevons un message texte, nous ", infinitive: "répondre", textAfter: " tout de suite.", answer: "répondons" },
      { id: "re_11", textBefore: "Cette musique joyeuse ", infinitive: "rendre", textAfter: " toute la classe de bonne humeur.", answer: "rend" },
      { id: "re_12", textBefore: "Tu cherches partout parce que tu ", infinitive: "perdre", textAfter: " toujours tes écouteurs !", answer: "perds" }
    ]
  },
  {
    id: "writing_prompt",
